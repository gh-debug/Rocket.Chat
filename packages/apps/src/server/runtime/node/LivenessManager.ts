...
import type { NodeRuntimeSubprocessController } from './AppsEngineNodeRuntime';
...
/**
 * Responsible for pinging the Node subprocess and for restarting it
 * if something doesn't look right
 */
export class LivenessManager {
	private readonly controller: NodeRuntimeSubprocessController;
	...
	constructor(
		deps: {
			controller: NodeRuntimeSubprocessController;
	...
	public attach(node: ChildProcess) {
		this.subprocess = node;
