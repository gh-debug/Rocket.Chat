import type { BlockBuilder as _AppsEngineBlockBuilder } from '@rocket.chat/apps-engine/definition/uikit/blocks/BlockBuilder';

import { AppObjectRegistry } from '../../../AppObjectRegistry';

const { BlockBuilder: AppsEngineBlockBuilder } = require('@rocket.chat/apps-engine/definition/uikit/blocks/BlockBuilder.js') as {
	BlockBuilder: typeof _AppsEngineBlockBuilder;
};
