...
// The base-logic suites live in base-runtime/ and run under node:test. This is
// the Deno seam suite: it exercises the platform-specific error-handler
// registration and, in doing so, confirms the Deno adapter resolves the base
// source (the @rocket.chat/apps/base-runtime/... specifier) through the import
// map.
